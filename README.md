...
demo Cordova plugin with this Android NDK build can be built and tested from here: [`github:brodybits/cordova-sqlcipher-crypto-batch-connection-core-android-build-wip0010`](https://github.com/brodybits/cordova-sqlcipher-crypto-batch-connection-core-android-build-wip0010)
